...
• Sistema de aluguel de jogos (AluGames), com controle de estado e interação do usuário
• Carrinho de compras, com cálculo de valores e totalização dinâmica
• Sistema de compra de ingressos, com regras por tipo e controle de quantidade
• Amigo secreto, com listas, embaralhamento e sorteio automatizado

O objetivo foi fortalecer o raciocínio lógico, praticar resolução de problemas reais e construir projetos para compor meu portfólio como desenvolvedor.
